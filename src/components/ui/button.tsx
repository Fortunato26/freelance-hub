  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-danger text-white hover:bg-red-600 shadow-sm hover:shadow-md hover:shadow-danger/20",
        outline: "border border-border bg-white hover:bg-secondary-light hover:border-primary/20",
        secondary: "bg-secondary-light text-secondary hover:bg-gray-200",
        ghost: "hover:bg-secondary-light hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        success: "bg-success text-white hover:bg-emerald-600 shadow-sm hover:shadow-md hover:shadow-success/20",
        warning: "bg-warning text-white hover:bg-amber-600 shadow-sm hover:shadow-md hover:shadow-warning/20",
      },
      size: {
