      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-rd p-6">
          <div className="space-y-3 mb-6">
            <Button onClick={() => signIn('github', { callbackUrl: '/' })} className="w-full bg-gray-900 hover:bg-gray-800 text-white" type="button">
            ...
            <Button onClick={() => signIn('google', { callbackUrl: '/' })} variant="outline" className="w-full border-gray-200" type="button">
