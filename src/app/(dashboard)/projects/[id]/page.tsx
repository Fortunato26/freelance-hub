      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/projects" className="text-gray-400 hover:text-gray-900">
            ...
            <div>
              ...
              <p className="text-gray-500">{client?.name || 'Sem cliente'}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="bg-white border-gray-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Valor do Projeto</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Recebido</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Pago</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Prazo</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">{completedTasks}/{totalTasks} concluídas</p>
              </div>
              <Dialog open={isTaskDialogOpen} onOpenChange={setIsTaskDialogOpen}>
                <DialogTrigger asChild>
                  <Button size="sm" className="bg-blue-600 text-white">+ Tarefa</Button>
                </DialogTrigger>
                <DialogContent className="bg-white border-gray-200">
                  ...
                  <div className="space-y-4">
                    ...
                    />
                    <Button onClick={handleAddTask} className="w-full bg-blue-600 text-white">Adicionar</Button>
                  </div>
                </DialogContent>
              </Dialog>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-2">
                {projectTasks.length === 0 ? (
                  <p className="text-center text-gray-400 py-4">Nenhuma tarefa</p>
                ) : (
                  projectTasks.map((task) => (
                    <div key={task.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <span className={`flex-1 ${task.completed ? 'line-through text-gray-400' : 'text-gray-500'}`}>
                        {task.title}
                      </span>
                      <button
          ...
          <Card className="bg-white border-gray-200">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Dialog open={isPaymentDialogOpen} onOpenChange={setIsPaymentDialogOpen}>
                <DialogTrigger asChild>
                  <Button size="sm" className="bg-blue-600 text-white">+ Pagamento</Button>
                </DialogTrigger>
                <DialogContent className="bg-white border-gray-200">
                  <DialogHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <Input placeholder="Descrição" value={newPayment.description} onChange={(e) => setNewPayment({ ...newPayment, description: e.target.value })} className="bg-gray-50 border-gray-200" />
                    <Input type="number" placeholder="Valor" value={newPayment.amount} onChange={(e) => setNewPayment({ ...newPayment, amount: e.target.value })} className="bg-gray-50 border-gray-200" />
                    <Button onClick={handleAddPayment} className="w-full bg-blue-600 text-white">Adicionar</Button>
                  </div>
                </DialogContent>
              </Dialog>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                {projectPayments.length === 0 ? (
                  <p className="text-center text-gray-400 py-4">Nenhum pagamento</p>
                ) : (
